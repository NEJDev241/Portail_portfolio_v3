        ...
        <html lang="fr" >
           <body className="bg-gray-50 font-poppins font-medium">
                <div className="main-container flex min-h-screen">
                    ...
                    {/* La Sidebar */}
                    <aside className="w-64 bg-primary text-white py-6 px-5">
                        <div className="flex flex-col h-full justify-between">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                {/* Le Bouton Accueil */}
                                <button className="flex justify-center items-center text-center font-semibold gap-2 bg-white text-primary px-4 py-2 rounded-lg w-full cursor-pointer shadow">Accueil</button>
                            </div>
                            ...
                            <button className="flex justify-center items-center text-center font-semibold bg-white text-primary px-4 py-2 rounded-lg w-full cursor-pointer shadow">Déconnexion</button>
                        </div>
                    </aside>
